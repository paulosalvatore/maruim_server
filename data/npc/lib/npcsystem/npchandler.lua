...
if NpcHandler == nil then
	...
	NpcHandler = {
		...
		messages = {
			...
			[MESSAGE_ONSELL] 	= "Aqui está, |TOTALCOST| gold.",
			[MESSAGE_SOLD]	 	= "Vendido |ITEMCOUNT|x |ITEMNAME| por |TOTALCOST| gold.",
			[MESSAGE_MISSINGMONEY]	= "Você não possui dinheiro suficiente.",
			[MESSAGE_NEEDMONEY] 	= "Você não possui dinheiro suficiente.",
			[MESSAGE_MISSINGITEM] 	= "Você não possui essa quantidade.",
			[MESSAGE_NEEDITEM]	= "Você não possui esse item.",
			[MESSAGE_NEEDSPACE]	= "Você não possui capacidade suficiente.",
			[MESSAGE_NEEDMORESPACE]	= "Você não possui capacidade suficiente para todos os items.",
			[MESSAGE_IDLETIMEOUT] 	= "Adeus.",
			[MESSAGE_WALKAWAY] 	= "Adeus.",
			[MESSAGE_DECLINE]	= "Então não.",
			[MESSAGE_SENDTRADE]	= "É pra já, aqui está a lista de itens que eu negocio.",
			[MESSAGE_NOSHOP]	= "Desculpe, eu não tenho nada para oferecer.",
			[MESSAGE_ONCLOSESHOP]	= "Volte assim que você precisar de alguma coisa.",
			[MESSAGE_ALREADYFOCUSED]= "|PLAYERNAME|, eu já estou falando com você.",
			[MESSAGE_WALKAWAY_MALE]	= "Adeus.",
			[MESSAGE_WALKAWAY_FEMALE] 	= "Adeus."
		}
	}
