...
profissoes = {
	[20000] = {
		...
		receitas = {
			...
			{item = 20092, nivel = 8, nivelJogador = 25, ferramenta = 2422, materiais = {{2350, 1}, {20089, 5}, {11192, 5}}, fabricarQuantidade = 1, tempo = 7, experiencia = 185, pontos = 20, chanceSucesso = 7000, aprender = 0, atributos = {ataque = {1, 3}}},
			...
			-- Clavas de Uma Mão
			{item = 2439, nivel = 1, nivelJogador = 10, ferramenta = 2422, materiais = {{6107, 1}, {5880, 1}}, fabricarQuantidade = 1, tempo = 3, experiencia = 20, pontos = 2, chanceSucesso = 9000, aprender = 0, atributos = {ataque = {0, 3}}},
			{item = 2417, nivel = 2, nivelJogador = 15, ferramenta = 2422, materiais = {{2556, 1}, {5880, 2}}, fabricarQuantidade = 1, tempo = 3, experiencia = 42, pontos = 3, chanceSucesso = 9000, aprender = 0, atributos = {ataque = {0, 3}}},
			{item = 3966, nivel = 3, nivelJogador = 15, ferramenta = 2422, materiais = {{6107, 1}, {12467, 3}, {5880, 1}}, fabricarQuantidade = 1, tempo = 5, experiencia = 65, pontos = 5, chanceSucesso = 8000, aprender = 0, atributos = {ataque = {0, 3}}},
			{item = 2394, nivel = 4, nivelJogador = 20, ferramenta = 2422, materiais = {{2556, 1}, {11325, 3}, {5880, 2}}, fabricarQuantidade = 1, tempo = 5, experiencia = 87, pontos = 7, chanceSucesso = 8000, aprender = 0, atributos = {ataque = {0, 3}}},
			{item = 20093, nivel = 5, nivelJogador = 20, ferramenta = 2422, materiais = {{6107, 1}, {11113, 5}, {5880, 3}}, fabricarQuantidade = 1, tempo = 7, experiencia = 120, pontos = 9, chanceSucesso = 8000, aprender = 0, atributos = {ataque = {0, 3}}},
			{item = 2423, nivel = 6, nivelJogador = 25, ferramenta = 2422, materiais = {{6107, 1}, {2327, 1}, {5880, 5}}, fabricarQuantidade = 1, tempo = 7, experiencia = 175, pontos = 12, chanceSucesso = 7000, aprender = 0, atributos = {ataque = {0, 3}}},
			{item = 7381, nivel = 7, nivelJogador = 25, ferramenta = 2321, materiais = {{2556, 1}, {2231, 2}, {11238, 5}}, fabricarQuantidade = 1, tempo = 10, experiencia = 175, pontos = 15, chanceSucesso = 7000, aprender = 0, atributos = {ataque = {1, 3}}},
			...
			{item = 2434, nivel = 10, nivelJogador = 35, ferramenta = 2321, materiais = {{2556, 1}, {12506, 1}, {5880, 5}}, fabricarQuantidade = 1, tempo = 10, experiencia = 250, pontos = 25, chanceSucesso = 6000, maxChanceSucesso = 9000, aprender = 0, atributos = {ataque = {1, 3}}},
			{item = 7387, nivel = 11, nivelJogador = 35, ferramenta = 2422, materiais = {{6107, 1}, {2145, 5}, {5880, 5}}, fabricarQuantidade = 1, tempo = 10, experiencia = 265, pontos = 32, chanceSucesso = 6000, maxChanceSucesso = 9000, aprender = 0, atributos = {ataque = {1, 3}}},
			...
			{item = 2436, nivel = 12, nivelJogador = 40, ferramenta = 2422, materiais = {{6107, 1}, {2229, 20}, {5880, 5}}, fabricarQuantidade = 1, tempo = 10, experiencia = 283, pontos = 40, chanceSucesso = 5000, maxChanceSucesso = 8000, aprender = 0, atributos = {ataque = {1, 3}}},
			{item = 7437, nivel = 12, nivelJogador = 40, ferramenta = 2321, materiais = {{2556, 1}, {2146, 5}, {5880, 5}}, fabricarQuantidade = 1, tempo = 10, experiencia = 283, pontos = 40, chanceSucesso = 5000, maxChanceSucesso = 8000, aprender = 0, atributos = {ataque = {1, 3}}},
			...
			{item = 7451, nivel = 13, nivelJogador = 45, ferramenta = 2321, materiais = {{6107, 1}, {21446, 2}, {5880, 5}}, fabricarQuantidade = 1, tempo = 10, experiencia = 300, pontos = 45, chanceSucesso = 5000, maxChanceSucesso = 8000, aprender = 0, atributos = {ataque = {1, 3}}},
			{item = 3961, nivel = 13, nivelJogador = 45, ferramenta = 2321, materiais = {{6107, 1}, {11367, 20}, {5880, 10}}, fabricarQuantidade = 1, tempo = 10, experiencia = 300, pontos = 45, chanceSucesso = 5000, maxChanceSucesso = 8000, aprender = 0, atributos = {ataque = {1, 3}}},
			...
			{item = 7409, nivel = 14, nivelJogador = 50, ferramenta = 2422, materiais = {{6107, 1}, {10578, 20}, {5880, 15}}, fabricarQuantidade = 1, tempo = 10, experiencia = 330, pontos = 55, chanceSucesso = 4000, maxChanceSucesso = 7000, aprender = 0, atributos = {ataque = {1, 3}}},
			...
			-- Clavas de Duas Mãos
			{item = 7425, nivel = 1, nivelJogador = 10, ferramenta = 2321, materiais = {{6107, 1}, {2229, 1}, {13757, 1}}, fabricarQuantidade = 1, tempo = 5, experiencia = 30, pontos = 2, chanceSucesso = 9000, aprender = 0, atributos = {ataque = {0, 4}}},
			{item = 7379, nivel = 7, nivelJogador = 25, ferramenta = 2321, materiais = {{6107, 1}, {2229, 1}, {13757, 1}}, fabricarQuantidade = 1, tempo = 10, experiencia = 180, pontos = 15, chanceSucesso = 7000, aprender = 0, atributos = {ataque = {0, 4}}},
			...
			{item = 7424, nivel = 13, nivelJogador = 45, ferramenta = 2321, materiais = {{6107, 1}, {10577, 1}, {5880, 1}}, fabricarQuantidade = 1, tempo = 15, experiencia = 315, pontos = 45, chanceSucesso = 5000, maxChanceSucesso = 8000, aprender = 0, atributos = {ataque = {1, 4}}},
			{item = 7452, nivel = 13, nivelJogador = 45, ferramenta = 2422, materiais = {{6107, 1}, {11325, 1}, {5880, 3}}, fabricarQuantidade = 1, tempo = 15, experiencia = 315, pontos = 45, chanceSucesso = 5000, maxChanceSucesso = 8000, aprender = 0, atributos = {ataque = {1, 4}}},
			...
			{item = 7426, nivel = 14, nivelJogador = 50, ferramenta = 2422, materiais = {{6107, 1}, {9970, 5}, {21585, 1}}, fabricarQuantidade = 1, tempo = 15, experiencia = 340, pontos = 55, chanceSucesso = 4000, maxChanceSucesso = 7000, aprender = 0, atributos = {ataque = {1, 4}}},
			{item = 15400, nivel = 15, nivelJogador = 60, ferramenta = 2321, materiais = {{6107, 1}, {15426, 2}, {5880, 5}}, fabricarQuantidade = 1, tempo = 15, experiencia = 380, pontos = 67, chanceSucesso = 4000, maxChanceSucesso = 7000, aprender = 0, atributos = {ataque = {0, 5}}},
			...
			{item = 20108, nivel = 16, nivelJogador = 60, ferramenta = 2422, materiais = {{10564, 5}, {11224, 5}, {5880, 5}}, fabricarQuantidade = 1, tempo = 20, experiencia = 425, pontos = 81, chanceSucesso = 3000, maxChanceSucesso = 6000, aprender = 0, atributos = {ataque = {0, 5}}},
			...
			{item = 11308, nivel = 17, nivelJogador = 65, ferramenta = 2422, materiais = {{6107, 1}, {5580, 10}, {13757, 10}}, fabricarQuantidade = 1, tempo = 20, experiencia = 465, pontos = 97, chanceSucesso = 3000, maxChanceSucesso = 6000, aprender = 0, atributos = {ataque = {0, 5}}},
			{item = 7428, nivel = 17, nivelJogador = 65, ferramenta = 2421, materiais = {{2394, 1}, {5925, 5}, {2146, 20}}, fabricarQuantidade = 1, tempo = 20, experiencia = 465, pontos = 97, chanceSucesso = 3000, maxChanceSucesso = 6000, aprender = 0, atributos = {ataque = {0, 5}}},
			...
			-- Bestas
			{item = 8849, nivel = 12, nivelJogador = 40, ferramenta = 2558, materiais = {{12407, 1}, {5901, 10}, {12448, 10}}, fabricarQuantidade = 1, tempo = 12, experiencia = 290, pontos = 43, chanceSucesso = 4000, maxChanceSucesso = 6500, aprender = 0},
			...
			{item = 21690, nivel = 17, nivelJogador = 65, ferramenta = 13115, materiais = {{2455, 1}, {13758, 10}, {11198, 10}}, fabricarQuantidade = 1, tempo = 20, experiencia = 465, pontos = 97, chanceSucesso = 3000, maxChanceSucesso = 5000, aprender = 0},
			...
			{item = 5803, nivel = 19, nivelJogador = 70, ferramenta = 2558, materiais = {{8849, 1}, {5901, 20}, {12503, 5}}, fabricarQuantidade = 1, tempo = 20, experiencia = 550, pontos = 130, chanceSucesso = 2500, maxChanceSucesso = 4000, aprender = 0},
			...
			-- Arcos
			{item = 8857, nivel = 1, nivelJogador = 10, ferramenta = 2558, materiais = {{5901, 1}, {8860, 5}}, fabricarQuantidade = 1, tempo = 5, experiencia = 30, pontos = 10, chanceSucesso = 8000, aprender = 0},
			{item = 7438, nivel = 3, nivelJogador = 15, ferramenta = 2558, materiais = {{5901, 1}, {7731, 5}, {12420, 1}}, fabricarQuantidade = 1, tempo = 5, experiencia = 70, pontos = 10, chanceSucesso = 6500, maxChanceSucesso = 8500, aprender = 0},
			{item = 21696, nivel = 8, nivelJogador = 30, ferramenta = 2558, materiais = {{2456, 1}, {7290, 5}}, fabricarQuantidade = 1, tempo = 10, experiencia = 190, pontos = 10, chanceSucesso = 5000, maxChanceSucesso = 7000, aprender = 0},
