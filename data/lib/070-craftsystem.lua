...
profissoes = {
	[20000] = {
		...
		receitas = {
			...
			-- Armors
			{item = 2503, nivel = 1, nivelJogador = 10, ferramenta = 2422, materiais = {{2463, 1}, {5880, 3}, {5900, 2}}, fabricarQuantidade = 1, tempo = 3, experiencia = 25, pontos = 2, chanceSucesso = 8000, aprender = 0, atributos = {armadura = {1, 3}}},
			{item = 2486, nivel = 2, nivelJogador = 20, ferramenta = 2422, materiais = {{2463, 1}, {13543, 1}, {13540, 1}}, fabricarQuantidade = 1, tempo = 5, experiencia = 40, pontos = 3, chanceSucesso = 5000, aprender = 0, atributos = {armadura = {1, 3}}},
			{item = 2476, nivel = 5, nivelJogador = 40, ferramenta = 2422, materiais = {{2463, 1}, {5880, 10}}, fabricarQuantidade = 1, tempo = 10, experiencia = 80, pontos = 10, chanceSucesso = 4000, aprender = 0, atributos = {armadura = {1, 3}}},
			...
			{item = 8877, nivel = 8, nivelJogador = 60, ferramenta = 2422, materiais = {{2463, 1}, {8299, 5}, {5880, 10}}, fabricarQuantidade = 1, tempo = 15, experiencia = 230, pontos = 15, chanceSucesso = 3000, maxChanceSucesso = 5000, aprender = 0, atributos = {armadura = {1, 2}}},
			...
			{item = 2500, nivel = 15, nivelJogador = 1, ferramenta = 2422, materiais = {{2463, 1}, {7249, 2}, {12399, 5}}, fabricarQuantidade = 1, tempo = 15, experiencia = 800, pontos = 50, chanceSucesso = 1500, maxChanceSucesso = 3000, aprender = 0, atributos = {armadura = {1, 2}}},
			...
			{item = 8878, nivel = 8, nivelJogador = 60, ferramenta = 2422, materiais = {{2463, 1}, {8302, 5}, {5880, 10}}, fabricarQuantidade = 1, tempo = 15, experiencia = 230, pontos = 15, chanceSucesso = 3000, maxChanceSucesso = 5000, aprender = 0, atributos = {armadura = {1, 2}}},
			...
			{item = 8880, nivel = 9, nivelJogador = 70, ferramenta = 2422, materiais = {{2463, 1}, {7736, 5}, {5880, 10}}, fabricarQuantidade = 1, tempo = 15, experiencia = 300, pontos = 20, chanceSucesso = 2500, maxChanceSucesso = 4500, aprender = 0, atributos = {armadura = {1, 2}}},
			...
			{item = 15407, nivel = 15, nivelJogador = 120, ferramenta = 2321, materiais = {{2463, 1}, {15455, 20}, {15430, 10}, {5880, 10}}, fabricarQuantidade = 1, tempo = 20, experiencia = 1000, pontos = 75, chanceSucesso = 1000, maxChanceSucesso = 2500, aprender = 0, atributos = {armadura = {1, 3}}},
			...
			-- Helmets
			{item = 2502, nivel = 1, nivelJogador = 10, ferramenta = 2422, materiais = {{9820, 1}, {5880, 2}, {5900, 1}}, fabricarQuantidade = 1, tempo = 3, experiencia = 15, pontos = 2, chanceSucesso = 9000, aprender = 0, atributos = {armadura = {1, 3}}},
			...
			{item = 2499, nivel = 15, nivelJogador = 1, ferramenta = 2422, materiais = {{9820, 1}, {7249, 1}, {12399, 3}}, fabricarQuantidade = 1, tempo = 15, experiencia = 700, pontos = 45, chanceSucesso = 2000, maxChanceSucesso = 3500, aprender = 0, atributos = {armadura = {1, 3}}},
			...
			{item = 2497, nivel = 10, nivelJogador = 30, ferramenta = 2422, materiais = {{9820, 1}, {2354, 1}, {5880, 10}}, fabricarQuantidade = 1, tempo = 7, experiencia = 350, pontos = 30, chanceSucesso = 5000, aprender = 0, atributos = {armadura = {1, 3}}},
			{item = 15408, nivel = 20, nivelJogador = 100, ferramenta = 2321, materiais = {{9820, 1}, {15423, 3}, {15430, 10}, {5880, 5}}, fabricarQuantidade = 1, tempo = 25, experiencia = 1400, pontos = 200, chanceSucesso = 1000, maxChanceSucesso = 3000, aprender = 0, atributos = {armadura = {1, 2}}},
			...
			{item = 5741, nivel = 15, nivelJogador = 80, ferramenta = 2321, materiais = {{2229, 20}, {6300, 3}}, fabricarQuantidade = 1, tempo = 15, experiencia = 900, pontos = 70, chanceSucesso = 2000, maxChanceSucesso = 4000, aprender = 0, atributos = {armadura = {1, 3}}},
			...
			{item = 11302, nivel = 17, nivelJogador = 80, ferramenta = 2422, materiais = {{9820, 1}, {5876, 10}, {11334, 10}, {5880, 10}}, fabricarQuantidade = 1, tempo = 20, experiencia = 1100, pontos = 100, chanceSucesso = 2000, maxChanceSucesso = 5000, aprender = 0, atributos = {armadura = {1, 3}}},
			...
			{item = 2504, nivel = 1, nivelJogador = 10, ferramenta = 2422, materiais = {{8678, 1}, {5880, 2}, {5900, 2}}, fabricarQuantidade = 1, tempo = 3, experiencia = 20, pontos = 2, chanceSucesso = 8000, aprender = 0, atributos = {armadura = {1, 3}}},
			{item = 15409, nivel = 20, nivelJogador = 100, ferramenta = 2321, materiais = {{8678, 1}, {15426, 5}, {15430, 10}, {5880, 5}}, fabricarQuantidade = 1, tempo = 25, experiencia = 1300, pontos = 180, chanceSucesso = 1500, maxChanceSucesso = 3500, aprender = 0, atributos = {armadura = {1, 2}}},
			...
			{item = 2477, nivel = 6, nivelJogador = 40, ferramenta = 2422, materiais = {{8678, 1}, {5880, 10}}, fabricarQuantidade = 1, tempo = 10, experiencia = 100, pontos = 10, chanceSucesso = 5000, aprender = 0, atributos = {armadura = {1, 3}}},
