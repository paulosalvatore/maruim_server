...
profissoes = {
	[20000] = {
		...
		receitas = {
			...
			{item = 3963, nivel = 4, nivelJogador = 25, ferramenta = 2321, materiais = {{2350, 1}, {5876, 4}, {5880, 2}}, fabricarQuantidade = 1, tempo = 5, experiencia = 130, pontos = 7, chanceSucesso = 8000, aprender = 0, atributos = {ataque = {1, 3}}},--330
