...
profissoes = {
	[20000] = {
		...
		receitas = {
			...
			{item = 7402, nivel = 15, nivelJogador = 60, ferramenta = 2434, materiais = {{2350, 1}, {10020, 5}, {5919, 5}}, fabricarQuantidade = 1, tempo = 20, experiencia = 370, pontos = 65, chanceSucesso = 3000, maxChanceSucesso = 5000, aprender = 0, atributos = {ataque = {0, 5}}},
