...
profissoes = {
	[20000] = {
		...
		receitas = {
			...
			{item = 15408, nivel = 20, nivelJogador = 100, ferramenta = 2321, materiais = {{9820, 1}, {15423, 3}, {15430, 10}, {5880, 5}}, fabricarQuantidade = 1, tempo = 25, experiencia = 1400, pontos = 200, chanceSucesso = 1000, maxChanceSucesso = 3000, aprender = 0, atributos = {armadura = {1, 2}}},--1880
			...
			{item = 5741, nivel = 15, nivelJogador = 80, ferramenta = 2321, materiais = {{2229, 20}, {6300, 3}}, fabricarQuantidade = 1, tempo = 15, experiencia = 900, pontos = 70, chanceSucesso = 2000, maxChanceSucesso = 4000, aprender = 0, atributos = {armadura = {1, 3}}},--2500
			...
			{item = 11302, nivel = 17, nivelJogador = 80, ferramenta = 2422, materiais = {{9820, 1}, {5876, 10}, {11334, 10}, {5880, 10}}, fabricarQuantidade = 1, tempo = 20, experiencia = 1100, pontos = 100, chanceSucesso = 2000, maxChanceSucesso = 5000, aprender = 0, atributos = {armadura = {1, 3}}},--1430
			...
			{item = 2500, nivel = 15, nivelJogador = 1, ferramenta = 2422, materiais = {{2463, 1}, {7249, 2}, {12399, 5}}, fabricarQuantidade = 1, tempo = 15, experiencia = 800, pontos = 50, chanceSucesso = 1500, maxChanceSucesso = 3000, aprender = 0, atributos = {armadura = {1, 2}}},--300
			...
			{item = 8880, nivel = 9, nivelJogador = 70, ferramenta = 2422, materiais = {{2463, 1}, {7736, 5}, {5880, 10}}, fabricarQuantidade = 1, tempo = 15, experiencia = 300, pontos = 20, chanceSucesso = 2500, maxChanceSucesso = 4500, aprender = 0, atributos = {armadura = {1, 2}}},--750
			...
			{item = 15407, nivel = 15, nivelJogador = 120, ferramenta = 2321, materiais = {{2463, 1}, {15455, 20}, {15430, 10}, {5880, 10}}, fabricarQuantidade = 1, tempo = 20, experiencia = 1000, pontos = 75, chanceSucesso = 1000, maxChanceSucesso = 2500, aprender = 0, atributos = {armadura = {1, 3}}},--5300
			...
			-- Clavas de Uma Mão
			{item = 2439, nivel = 1, nivelJogador = 10, ferramenta = 2422, materiais = {{6107, 1}, {5880, 1}}, fabricarQuantidade = 1, tempo = 3, experiencia = 20, pontos = 2, chanceSucesso = 9000, aprender = 0, atributos = {ataque = {0, 3}}},--80
			{item = 2417, nivel = 2, nivelJogador = 15, ferramenta = 2422, materiais = {{2556, 1}, {5880, 2}}, fabricarQuantidade = 1, tempo = 3, experiencia = 42, pontos = 3, chanceSucesso = 9000, aprender = 0, atributos = {ataque = {0, 3}}},--130
			{item = 3966, nivel = 3, nivelJogador = 15, ferramenta = 2422, materiais = {{6107, 1}, {12467, 3}, {5880, 1}}, fabricarQuantidade = 1, tempo = 5, experiencia = 65, pontos = 5, chanceSucesso = 8000, aprender = 0, atributos = {ataque = {0, 3}}},--140
			{item = 2394, nivel = 4, nivelJogador = 20, ferramenta = 2422, materiais = {{2556, 1}, {11325, 1}, {5880, 2}}, fabricarQuantidade = 1, tempo = 5, experiencia = 87, pontos = 7, chanceSucesso = 8000, aprender = 0, atributos = {ataque = {0, 3}}},--215
			{item = 20093, nivel = 5, nivelJogador = 20, ferramenta = 2422, materiais = {{6107, 1}, {11113, 10}, {5880, 3}}, fabricarQuantidade = 1, tempo = 7, experiencia = 120, pontos = 9, chanceSucesso = 8000, aprender = 0, atributos = {ataque = {0, 3}}},--230
			...
			{item = 7381, nivel = 7, nivelJogador = 25, ferramenta = 2321, materiais = {{2556, 1}, {2230, 10}, {11238, 10}}, fabricarQuantidade = 1, tempo = 10, experiencia = 175, pontos = 15, chanceSucesso = 7000, aprender = 0, atributos = {ataque = {1, 3}}},--330
			...
			{item = 2434, nivel = 10, nivelJogador = 35, ferramenta = 2321, materiais = {{2556, 1}, {5920, 1}, {5880, 5}}, fabricarQuantidade = 1, tempo = 10, experiencia = 250, pontos = 25, chanceSucesso = 6000, maxChanceSucesso = 9000, aprender = 0, atributos = {ataque = {1, 3}}},--430
			{item = 7387, nivel = 11, nivelJogador = 35, ferramenta = 2422, materiais = {{6107, 1}, {2145, 5}, {5880, 5}}, fabricarQuantidade = 1, tempo = 10, experiencia = 265, pontos = 32, chanceSucesso = 6000, maxChanceSucesso = 9000, aprender = 0, atributos = {ataque = {1, 3}}},--530
			...
			{item = 2436, nivel = 12, nivelJogador = 40, ferramenta = 2422, materiais = {{6107, 1}, {2229, 6}, {5880, 6}}, fabricarQuantidade = 1, tempo = 10, experiencia = 283, pontos = 40, chanceSucesso = 5000, maxChanceSucesso = 8000, aprender = 0, atributos = {ataque = {1, 3}}},--630
			{item = 7437, nivel = 12, nivelJogador = 40, ferramenta = 2321, materiais = {{2556, 1}, {2146, 7}, {5880, 7}}, fabricarQuantidade = 1, tempo = 10, experiencia = 283, pontos = 40, chanceSucesso = 5000, maxChanceSucesso = 8000, aprender = 0, atributos = {ataque = {1, 3}}},--730
			...
			{item = 7451, nivel = 13, nivelJogador = 45, ferramenta = 2321, materiais = {{6107, 1}, {21446, 1}, {5880, 5}}, fabricarQuantidade = 1, tempo = 10, experiencia = 300, pontos = 45, chanceSucesso = 5000, maxChanceSucesso = 8000, aprender = 0, atributos = {ataque = {1, 3}}},--1080
			{item = 3961, nivel = 13, nivelJogador = 45, ferramenta = 2321, materiais = {{6107, 1}, {11367, 30}, {5880, 15}}, fabricarQuantidade = 1, tempo = 10, experiencia = 300, pontos = 45, chanceSucesso = 5000, maxChanceSucesso = 8000, aprender = 0, atributos = {ataque = {1, 3}}},--1140
			...
			{item = 7409, nivel = 14, nivelJogador = 50, ferramenta = 2422, materiais = {{6107, 1}, {8302, 10}, {5880, 15}}, fabricarQuantidade = 1, tempo = 10, experiencia = 330, pontos = 55, chanceSucesso = 4000, maxChanceSucesso = 7000, aprender = 0, atributos = {ataque = {1, 3}}},--1380
