...
profissoes = {
	[20000] = {
		...
		receitas = {
			...
			{item = 2502, nivel = 2, nivelJogador = 15, ferramenta = 2422, materiais = {{9820, 1}, {5880, 2}, {5900, 1}}, fabricarQuantidade = 1, tempo = 3, experiencia = 30, pontos = 2, chanceSucesso = 9000, aprender = 0, atributos = {armadura = {0, 2}}},--155
			-- {item = 3972, nivel = 3, nivelJogador = 1, ferramenta = 2422, materiais = {{9820, 1}, {5898, 10}}, fabricarQuantidade = 1, tempo = 0, experiencia = 10, pontos = 10, chanceSucesso = 1000, maxChanceSucesso = 2000, aprender = 0, atributos = {armadura = {0, 3}}},
			{item = 2499, nivel = 4, nivelJogador = 1, ferramenta = 2422, materiais = {{9820, 1}, {7249, 2}, {12399, 3}}, fabricarQuantidade = 1, tempo = 15, experiencia = 350, pontos = 70, chanceSucesso = 2000, maxChanceSucesso = 3500, aprender = 0, atributos = {armadura = {1, 2}}},--190
			...
			-- Escudos
			{item = 2521, nivel = 1, nivelJogador = 10, ferramenta = 2422, materiais = {{9814, 1}, {2230, 2}}, fabricarQuantidade = 1, tempo = 0, experiencia = 40, pontos = 2, chanceSucesso = 9000, aprender = 0, atributos = {defesa = {0, 3}}},--60
			...
			{item = 6131, nivel = 2, nivelJogador = 15, ferramenta = 2422, materiais = {{9814, 1}, {5899, 3}, {5880, 1}}, fabricarQuantidade = 1, tempo = 4, experiencia = 70, pontos = 3, chanceSucesso = 9000, aprender = 0, atributos = {defesa = {1, 3}}},--145
			{item = 3973, nivel = 3, nivelJogador = 20, ferramenta = 2321, materiais = {{9814, 1}, {5901, 2}, {3956, 2}}, fabricarQuantidade = 1, tempo = 0, experiencia = 100, pontos = 5, chanceSucesso = 8000, aprender = 0, atributos = {defesa = {0, 3}}},--190
			{item = 7460, nivel = 3, nivelJogador = 20, ferramenta = 2321, materiais = {{9814, 1}, {10575, 1}, {5901, 3}}, fabricarQuantidade = 1, tempo = 0, experiencia = 100, pontos = 5, chanceSucesso = 8000, aprender = 0, atributos = {defesa = {0, 3}}},--250
			-- {item = 2518, nivel = 3, nivelJogador = 20, ferramenta = 2321, materiais = {{9814, 1}, {5898, 10}, {2230, 10}}, fabricarQuantidade = 1, tempo = 0, experiencia = 10, pontos = 5, chanceSucesso = 8000, maxChanceSucesso = 2000, aprender = 0, atributos = {defesa = {0, 3}}},
			{item = 2515, nivel = 4, nivelJogador = 25, ferramenta = 2321, materiais = {{9814, 1}, {12470, 1}, {12505, 1}}, fabricarQuantidade = 1, tempo = 7, experiencia = 130, pontos = 7, chanceSucesso = 7000, maxChanceSucesso = 9000, aprender = 0, atributos = {defesa = {1, 3}}},--390
			{item = 2516, nivel = 5, nivelJogador = 25, ferramenta = 2434, materiais = {{9814, 1}, {21401, 3}, {5877, 2}, {5920, 1}}, fabricarQuantidade = 1, tempo = 3, experiencia = 175, pontos = 10, chanceSucesso = 7000, maxChanceSucesso = 9000, aprender = 0, atributos = {defesa = {1, 3}}},--550
			{item = 21697, nivel = 6, nivelJogador = 30, ferramenta = 7777, materiais = {{9814, 1}, {10578, 15}, {8302, 5}, {10549, 1}}, fabricarQuantidade = 1, tempo = 15, experiencia = 230, pontos = 14, chanceSucesso = 7000, maxChanceSucesso = 9000, aprender = 0, atributos = {defesa = {0, 4}}},--615
			{item = 2528, nivel = 7, nivelJogador = 50, ferramenta = 2321, materiais = {{9814, 1}, {2159, 5}, {12505, 1}}, fabricarQuantidade = 1, tempo = 15, experiencia = 300, pontos = 19, chanceSucesso = 6000, maxChanceSucesso = 8000, aprender = 0, atributos = {defesa = {1, 3}}}, -- 820
			{item = 2537, nivel = 7, nivelJogador = 1, ferramenta = 2422, materiais = {{9814, 1}, {12399, 10}, {7249, 10}, {12505, 1}}, fabricarQuantidade = 1, tempo = 10, experiencia = 290, pontos = 19, chanceSucesso = 6000, maxChanceSucesso = 8000, aprender = 0, atributos = {defesa = {1, 3}}},--1020
			...
			{item = 2536, nivel = 8, nivelJogador = 60, ferramenta = 2321, materiais = {{9814, 1}, {11226, 10}, {16105, 2}}, fabricarQuantidade = 1, tempo = 10, experiencia = 350, pontos = 25, chanceSucesso = 5000, maxChanceSucesso = 7000, aprender = 0, atributos = {defesa = {1, 3}}}, -- 1400
			...
			{item = 2534, nivel = 10, nivelJogador = 75, ferramenta = 2321, materiais = {{9814, 1}, {12405, 20}, {21241, 10}, {21244, 1}}, fabricarQuantidade = 1, tempo = 7, experiencia = 470, pontos = 38, chanceSucesso = 4000, maxChanceSucesso = 5500, aprender = 0, atributos = {defesa = {1, 3}}}, -- 1950
