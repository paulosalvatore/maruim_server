...
profissoes = {
	[20000] = {
		...
		receitas = {
			...
			{item = 2457, nivel = 1, nivelJogador = 10, ferramenta = 2422, materiais = {{5880, 1}}, fabricarQuantidade = 1, tempo = 3, experiencia = 35, pontos = 2, chanceSucesso = 9000, aprender = 0, atributos = {armadura = {0, 2}}},--50
			{item = 2502, nivel = 2, nivelJogador = 15, ferramenta = 2422, materiais = {{9820, 1}, {5880, 1}, {5900, 1}}, fabricarQuantidade = 1, tempo = 3, experiencia = 30, pontos = 3, chanceSucesso = 9000, aprender = 0, atributos = {armadura = {0, 2}}},--105
			-- {item = 3972, nivel = 3, nivelJogador = 20, ferramenta = 2422, materiais = {{9820, 1}, {5898, 10}}, fabricarQuantidade = 1, tempo = 0, experiencia = 10, pontos = 10, chanceSucesso = 8000, aprender = 0, atributos = {armadura = {0, 3}}},
			{item = 2499, nivel = 4, nivelJogador = 25, ferramenta = 2321, materiais = {{9820, 1}, {7249, 2}, {12399, 3}}, fabricarQuantidade = 1, tempo = 7, experiencia = 350, pontos = 7, chanceSucesso = 8000, aprender = 0, atributos = {armadura = {1, 2}}},--190
			-- {item = 2491, nivel = 5, nivelJogador = 30, ferramenta = 2321, materiais = {{2128, 1}, {5887, 2}}, fabricarQuantidade = 1, tempo = 0, experiencia = 10, pontos = 10, chanceSucesso = 7000, maxChanceSucesso = 9000, aprender = 0, atributos = {armadura = {0, 3}}},
			-- {item = 2475, nivel = 5, nivelJogador = 30, ferramenta = 2321, materiais = {{9820, 1}, {12438, 10}, {5880, 10}}, fabricarQuantidade = 1, tempo = 0, experiencia = 10, pontos = 10, chanceSucesso = 7000, maxChanceSucesso = 9000, aprender = 0, atributos = {armadura = {0, 3}}},
			{item = 2497, nivel = 6, nivelJogador = 35, ferramenta = 2321, materiais = {{9820, 1}, {2354, 1}, {12505, 1}}, fabricarQuantidade = 1, tempo = 13, experiencia = 250, pontos = 14, chanceSucesso = 6000, maxChanceSucesso = 8000, aprender = 0, atributos = {armadura = {1, 3}}},--700
			{item = 15408, nivel = 7, nivelJogador = 150, ferramenta = 2434, materiais = {{9820, 1}, {15423, 2}, {15430, 2}, {12505, 1}}, fabricarQuantidade = 1, tempo = 25, experiencia = 650, pontos = 19, chanceSucesso = 6000, maxChanceSucesso = 8000, aprender = 0, atributos = {armadura = {1, 2}}},--1140
			-- {item = 2498, nivel = 7, nivelJogador = 40, ferramenta = 2434, materiais = {{9820, 1}, {12640, 10}, {5887, 10}}, fabricarQuantidade = 1, tempo = 0, experiencia = 10, pontos = 10, chanceSucesso = 1000, maxChanceSucesso = 2000, aprender = 0, atributos = {armadura = {0, 3}}},
			{item = 5741, nivel = 8, nivelJogador = 45, ferramenta = 2434, materiais = {{2229, 10}, {6300, 3}}, fabricarQuantidade = 1, tempo = 17, experiencia = 350, pontos = 25, chanceSucesso = 5000, maxChanceSucesso = 7000, aprender = 0, atributos = {armadura = {1, 3}}},--2000
			...
			-- {item = 2496, nivel = 25, nivelJogador = 80, ferramenta = 7450, materiais = {{9820, 1}, {5954, 10}, {5888, 10}, {9941, 10}}, fabricarQuantidade = 1, tempo = 0, experiencia = 10, pontos = 10, chanceSucesso = 1000, maxChanceSucesso = 2000, aprender = 0, atributos = {armadura = {0, 3}}},
			-- {item = 2471, nivel = 30, nivelJogador = 85, ferramenta = 2444, materiais = {{9820, 1}, {15515, 3}, {5904, 1}}, fabricarQuantidade = 1, tempo = 0, experiencia = 10, pontos = 10, chanceSucesso = 1000, maxChanceSucesso = 2000, aprender = 0, atributos = {armadura = {0, 3}}},
			
			-- Armaduras
			{item = 2463, nivel = 1, nivelJogador = 10, ferramenta = 2422, materiais = {{5880, 3}}, fabricarQuantidade = 1, tempo = 3, experiencia = 40, pontos = 2, chanceSucesso = 9000, aprender = 0, atributos = {armadura = {1, 3}}},--150
			{item = 2503, nivel = 2, nivelJogador = 20, ferramenta = 2422, materiais = {{9808, 1}, {5880, 3}, {5900, 2}}, fabricarQuantidade = 1, tempo = 3, experiencia = 25, pontos = 2, chanceSucesso = 9000, aprender = 0, atributos = {armadura = {1, 3}}},--300
			{item = 2486, nivel = 3, nivelJogador = 25, ferramenta = 2422, materiais = {{9808, 1}, {5911, 5}, {5914, 5}}, fabricarQuantidade = 1, tempo = 5, experiencia = 40, pontos = 3, chanceSucesso = 5000, aprender = 0, atributos = {armadura = {1, 3}}},--400
			{item = 2476, nivel = 4, nivelJogador = 30, ferramenta = 2422, materiais = {{9808, 1}, {12505, 1}}, fabricarQuantidade = 1, tempo = 10, experiencia = 80, pontos = 10, chanceSucesso = 4000, aprender = 0, atributos = {armadura = {1, 3}}},--600
			-- {item = 8891, nivel = 5, nivelJogador = 1, ferramenta = 2422, materiais = {{9808, 1}, {12425, 5}, {5887, 1}}, fabricarQuantidade = 1, tempo = 0, experiencia = 10, pontos = 10, chanceSucesso = 1000, maxChanceSucesso = 2000, aprender = 0, atributos = {armadura = {0, 3}}},
			{item = 8877, nivel = 8, nivelJogador = 60, ferramenta = 2422, materiais = {{9808, 1}, {8299, 10}, {5880, 10}}, fabricarQuantidade = 1, tempo = 15, experiencia = 230, pontos = 15, chanceSucesso = 3000, maxChanceSucesso = 5000, aprender = 0, atributos = {armadura = {1, 2}}},--900
			-- {item = 8887, nivel = 20, nivelJogador = 1, ferramenta = 2422, materiais = {{9808, 1}, {13028, 5}, {5880, 1}}, fabricarQuantidade = 1, tempo = 0, experiencia = 10, pontos = 10, chanceSucesso = 1000, maxChanceSucesso = 2000, aprender = 0, atributos = {armadura = {0, 3}}},
			{item = 2500, nivel = 15, nivelJogador = 1, ferramenta = 2422, materiais = {{9808, 1}, {7249, 2}, {12399, 5}}, fabricarQuantidade = 1, tempo = 15, experiencia = 350, pontos = 65, chanceSucesso = 1500, maxChanceSucesso = 3000, aprender = 0, atributos = {armadura = {1, 2}}},--300
			-- {item = 2487, nivel = 40, nivelJogador = 1, ferramenta = 2422, materiais = {{9808, 1}, {5887, 2}}, fabricarQuantidade = 1, tempo = 0, experiencia = 10, pontos = 10, chanceSucesso = 1000, maxChanceSucesso = 2000, aprender = 0, atributos = {armadura = {0, 3}}},
			{item = 8878, nivel = 8, nivelJogador = 60, ferramenta = 2422, materiais = {{9808, 1}, {8302, 5}, {5880, 10}}, fabricarQuantidade = 1, tempo = 15, experiencia = 230, pontos = 15, chanceSucesso = 3000, maxChanceSucesso = 5000, aprender = 0, atributos = {armadura = {1, 2}}},--900
			-- {item = 8885, nivel = 20, nivelJogador = 1, ferramenta = 2422, materiais = {{9808, 1}, {8301, 5}, {5880, 1}}, fabricarQuantidade = 1, tempo = 0, experiencia = 10, pontos = 10, chanceSucesso = 1000, maxChanceSucesso = 2000, aprender = 0, atributos = {armadura = {0, 3}}},
			-- {item = 8886, nivel = 20, nivelJogador = 1, ferramenta = 2422, materiais = {{9808, 1}, {18425, 5}, {5880, 1}}, fabricarQuantidade = 1, tempo = 0, experiencia = 10, pontos = 10, chanceSucesso = 1000, maxChanceSucesso = 2000, aprender = 0, atributos = {armadura = {0, 3}}},
			-- {item = 8879, nivel = 20, nivelJogador = 1, ferramenta = 2422, materiais = {{9808, 1}, {8303, 5}, {5880, 1}}, fabricarQuantidade = 1, tempo = 0, experiencia = 10, pontos = 10, chanceSucesso = 1000, maxChanceSucesso = 2000, aprender = 0, atributos = {armadura = {0, 3}}},
			{item = 8880, nivel = 9, nivelJogador = 70, ferramenta = 2422, materiais = {{9808, 1}, {7736, 5}, {5880, 10}}, fabricarQuantidade = 1, tempo = 15, experiencia = 225, pontos = 26, chanceSucesso = 2500, maxChanceSucesso = 4500, aprender = 0, atributos = {armadura = {1, 2}}},--750
			-- {item = 11301, nivel = 50, nivelJogador = 1, ferramenta = 2422, materiais = {{9808, 1}, {5876, 5}, {11332, 1}, {5880, 5}}, fabricarQuantidade = 1, tempo = 0, experiencia = 10, pontos = 10, chanceSucesso = 1000, maxChanceSucesso = 2000, aprender = 0, atributos = {armadura = {0, 3}}},
			-- {item = 2466, nivel = 50, nivelJogador = 1, ferramenta = 2444, materiais = {{9808, 1}, {15515, 3}, {5904, 1}}, fabricarQuantidade = 1, tempo = 0, experiencia = 10, pontos = 10, chanceSucesso = 1000, maxChanceSucesso = 2000, aprender = 0, atributos = {armadura = {0, 3}}},
			-- {item = 8889, nivel = 20, nivelJogador = 1, ferramenta = 2422, materiais = {{9808, 1}, {21446, 5}, {11233, 1}}, fabricarQuantidade = 1, tempo = 0, experiencia = 10, pontos = 10, chanceSucesso = 1000, maxChanceSucesso = 2000, aprender = 0, atributos = {armadura = {0, 3}}},
			-- {item = 8881, nivel = 20, nivelJogador = 1, ferramenta = 2422, materiais = {{9808, 1}, {10553, 5}, {5880, 1}, {10574, 1}}, fabricarQuantidade = 1, tempo = 0, experiencia = 10, pontos = 10, chanceSucesso = 1000, maxChanceSucesso = 2000, aprender = 0, atributos = {armadura = {0, 3}}},
			-- {item = 12607, nivel = 65, nivelJogador = 1, ferramenta = 2434, materiais = {{9808, 1}, {5881, 10}, {12616, 5}, {12629, 5}}, fabricarQuantidade = 1, tempo = 0, experiencia = 10, pontos = 10, chanceSucesso = 1000, maxChanceSucesso = 2000, aprender = 0, atributos = {armadura = {0, 3}}},
			-- {item = 2492, nivel = 70, nivelJogador = 1, ferramenta = 2434, materiais = {{9808, 1}, {5920, 10}, {5882, 5}, {5889, 3}}, fabricarQuantidade = 1, tempo = 0, experiencia = 10, pontos = 10, chanceSucesso = 1000, maxChanceSucesso = 2000, aprender = 0, atributos = {armadura = {0, 3}}},
			-- {item = 8882, nivel = 20, nivelJogador = 1, ferramenta = 2422, materiais = {{9808, 1}, {5930, 5}, {5880, 1}, {10574, 1}}, fabricarQuantidade = 1, tempo = 0, experiencia = 10, pontos = 10, chanceSucesso = 1000, maxChanceSucesso = 2000, aprender = 0, atributos = {armadura = {0, 3}}},
			-- {item = 18404, nivel = 75, nivelJogador = 1, ferramenta = 7450, materiais = {{9808, 1}, {11227, 1}, {18422, 5}, {18423, 2}}, fabricarQuantidade = 1, tempo = 0, experiencia = 10, pontos = 10, chanceSucesso = 1000, maxChanceSucesso = 2000, aprender = 0, atributos = {armadura = {0, 3}}},
			-- {item = 8884, nivel = 20, nivelJogador = 1, ferramenta = 2422, materiais = {{9808, 1}, {10583, 5}, {5880, 1}, {10574, 1}}, fabricarQuantidade = 1, tempo = 0, experiencia = 10, pontos = 10, chanceSucesso = 1000, maxChanceSucesso = 2000, aprender = 0, atributos = {armadura = {0, 3}}},
			-- {item = 8888, nivel = 20, nivelJogador = 1, ferramenta = 2422, materiais = {{9808, 1}, {12439, 5}, {7443, 1}, {5887, 1}}, fabricarQuantidade = 1, tempo = 0, experiencia = 10, pontos = 10, chanceSucesso = 1000, maxChanceSucesso = 2000, aprender = 0, atributos = {armadura = {0, 3}}},
			-- {item = 8883, nivel = 20, nivelJogador = 1, ferramenta = 2422, materiais = {{9808, 1}, {10582, 5}, {5880, 1}, {10574, 1}}, fabricarQuantidade = 1, tempo = 0, experiencia = 10, pontos = 10, chanceSucesso = 1000, maxChanceSucesso = 2000, aprender = 0, atributos = {armadura = {0, 3}}},
			{item = 15407, nivel = 15, nivelJogador = 120, ferramenta = 2321, materiais = {{9808, 1}, {15455, 20}, {15430, 10}, {5880, 10}}, fabricarQuantidade = 1, tempo = 20, experiencia = 370, pontos = 75, chanceSucesso = 1000, maxChanceSucesso = 2500, aprender = 0, atributos = {armadura = {1, 3}}},--5300
			-- {item = 2494, nivel = 50, nivelJogador = 1, ferramenta = 2421, materiais = {{9808, 1}, {6558, 10}, {5954, 5}, {5888, 3}}, fabricarQuantidade = 1, tempo = 0, experiencia = 10, pontos = 10, chanceSucesso = 1000, maxChanceSucesso = 2000, aprender = 0, atributos = {armadura = {0, 3}}},
			-- {item = 15406, nivel = 80, nivelJogador = 1, ferramenta = 7450, materiais = {{9808, 1}, {15434, 1}}, fabricarQuantidade = 1, tempo = 0, experiencia = 10, pontos = 10, chanceSucesso = 1000, maxChanceSucesso = 2000, aprender = 0, atributos = {armadura = {0, 3}}},
			-- {item = 12642, nivel = 65, nivelJogador = 1, ferramenta = 2434, materiais = {{9808, 1}, {5881, 10}, {12616, 5}, {12615, 5}}, fabricarQuantidade = 1, tempo = 0, experiencia = 10, pontos = 10, chanceSucesso = 1000, maxChanceSucesso = 2000, aprender = 0, atributos = {armadura = {0, 3}}},
			-- {item = 21706, nivel = 20, nivelJogador = 1, ferramenta = 2422, materiais = {{9808, 1}, {21705, 10}}, fabricarQuantidade = 1, tempo = 0, experiencia = 10, pontos = 10, chanceSucesso = 1000, maxChanceSucesso = 2000, aprender = 0, atributos = {armadura = {0, 3}}},

			-- Calças
			{item = 2647, nivel = 1, nivelJogador = 10, ferramenta = 2422, materiais = {{5880, 2}}, fabricarQuantidade = 1, tempo = 0, experiencia = 40, pontos = 2, chanceSucesso = 9000, aprender = 0, atributos = {armadura = {0, 3}}},--100
			...
			{item = 2504, nivel = 1, nivelJogador = 10, ferramenta = 2422, materiais = {{9811, 1}, {5880, 2}, {5900, 2}}, fabricarQuantidade = 1, tempo = 3, experiencia = 20, pontos = 2, chanceSucesso = 8000, aprender = 0, atributos = {armadura = {1, 3}}},--230
			{item = 15409, nivel = 20, nivelJogador = 100, ferramenta = 2321, materiais = {{9811, 1}, {15426, 5}, {15430, 10}, {5880, 5}}, fabricarQuantidade = 1, tempo = 25, experiencia = 1300, pontos = 180, chanceSucesso = 1500, maxChanceSucesso = 3500, aprender = 0, atributos = {armadura = {1, 2}}},--1580
			-- {item = 2488, nivel = 40, nivelJogador = 1, ferramenta = 2422, materiais = {{9811, 1}, {5887, 2}}, fabricarQuantidade = 1, tempo = 0, experiencia = 10, pontos = 10, chanceSucesso = 1000, maxChanceSucesso = 2000, aprender = 0, atributos = {armadura = {0, 3}}},
			-- {item = 15412, nivel = 80, nivelJogador = 1, ferramenta = 7450, materiais = {{9811, 1}, {15436, 1}}, fabricarQuantidade = 1, tempo = 0, experiencia = 10, pontos = 10, chanceSucesso = 1000, maxChanceSucesso = 2000, aprender = 0, atributos = {armadura = {0, 3}}},
			{item = 2477, nivel = 6, nivelJogador = 40, ferramenta = 2422, materiais = {{9811, 1}, {5880, 10}}, fabricarQuantidade = 1, tempo = 10, experiencia = 100, pontos = 10, chanceSucesso = 5000, aprender = 0, atributos = {armadura = {1, 3}}},--580
			-- {item = 18405, nivel = 75, nivelJogador = 1, ferramenta = 7450, materiais = {{9811, 1}, {11227, 1}, {18422, 5}, {18423, 2}}, fabricarQuantidade = 1, tempo = 0, experiencia = 10, pontos = 10, chanceSucesso = 1000, maxChanceSucesso = 2000, aprender = 0, atributos = {armadura = {0, 3}}},
			-- {item = 11304, nivel = 50, nivelJogador = 1, ferramenta = 2422, materiais = {{9811, 1}, {5876, 5}, {11330, 1}, {5880, 5}}, fabricarQuantidade = 1, tempo = 0, experiencia = 10, pontos = 10, chanceSucesso = 1000, maxChanceSucesso = 2000, aprender = 0, atributos = {armadura = {0, 3}}},
			-- {item = 2470, nivel = 50, nivelJogador = 1, ferramenta = 2444, materiais = {{9811, 1}, {15515, 3}, {5904, 1}}, fabricarQuantidade = 1, tempo = 0, experiencia = 10, pontos = 10, chanceSucesso = 1000, maxChanceSucesso = 2000, aprender = 0, atributos = {armadura = {0, 3}}},
			...
			{item = 6131, nivel = 2, nivelJogador = 15, ferramenta = 2422, materiais = {{9814, 1}, {5899, 3}, {5880, 1}}, fabricarQuantidade = 1, tempo = 5, experiencia = 70, pontos = 3, chanceSucesso = 9000, aprender = 0, atributos = {defesa = {1, 3}}},--145
			{item = 3973, nivel = 3, nivelJogador = 20, ferramenta = 2321, materiais = {{9814, 1}, {5901, 2}, {3956, 2}}, fabricarQuantidade = 1, tempo = 7, experiencia = 100, pontos = 5, chanceSucesso = 8000, aprender = 0, atributos = {defesa = {0, 3}}},--190
			{item = 7460, nivel = 3, nivelJogador = 20, ferramenta = 2321, materiais = {{9814, 1}, {10575, 1}, {5901, 3}}, fabricarQuantidade = 1, tempo = 7, experiencia = 100, pontos = 5, chanceSucesso = 8000, aprender = 0, atributos = {defesa = {0, 3}}},--250
			-- {item = 2518, nivel = 3, nivelJogador = 20, ferramenta = 2321, materiais = {{9814, 1}, {5898, 10}, {2230, 10}}, fabricarQuantidade = 1, tempo = 7, experiencia = 10, pontos = 5, chanceSucesso = 8000, maxChanceSucesso = 2000, aprender = 0, atributos = {defesa = {0, 3}}},
			{item = 2515, nivel = 4, nivelJogador = 25, ferramenta = 2321, materiais = {{9814, 1}, {12470, 1}, {12505, 1}}, fabricarQuantidade = 1, tempo = 7, experiencia = 130, pontos = 7, chanceSucesso = 8000, aprender = 0, atributos = {defesa = {1, 3}}},--390
			...
			{item = 21697, nivel = 6, nivelJogador = 30, ferramenta = 7777, materiais = {{9814, 1}, {10578, 15}, {8302, 5}, {10549, 1}}, fabricarQuantidade = 1, tempo = 10, experiencia = 230, pontos = 14, chanceSucesso = 7000, maxChanceSucesso = 9000, aprender = 0, atributos = {defesa = {0, 4}}},--615
			{item = 2528, nivel = 7, nivelJogador = 50, ferramenta = 2321, materiais = {{9814, 1}, {2159, 5}, {12505, 1}}, fabricarQuantidade = 1, tempo = 13, experiencia = 300, pontos = 19, chanceSucesso = 6000, maxChanceSucesso = 8000, aprender = 0, atributos = {defesa = {1, 3}}}, -- 820
			{item = 2537, nivel = 7, nivelJogador = 1, ferramenta = 2422, materiais = {{9814, 1}, {12399, 10}, {7249, 10}, {12505, 1}}, fabricarQuantidade = 1, tempo = 13, experiencia = 290, pontos = 19, chanceSucesso = 6000, maxChanceSucesso = 8000, aprender = 0, atributos = {defesa = {1, 3}}},--1020
			-- {item = 2519, nivel = 7, nivelJogador = 50, ferramenta = 2422, materiais = {{9814, 1}, {5887, 2}}, fabricarQuantidade = 1, tempo = 0, experiencia = 290, pontos = 19, chanceSucesso = 1000, maxChanceSucesso = 2000, aprender = 0, atributos = {defesa = {0, 3}}},
			{item = 2536, nivel = 8, nivelJogador = 60, ferramenta = 2321, materiais = {{9814, 1}, {11226, 10}, {16105, 2}}, fabricarQuantidade = 1, tempo = 10, experiencia = 17, pontos = 25, chanceSucesso = 6000, maxChanceSucesso = 7000, aprender = 0, atributos = {defesa = {1, 3}}}, -- 1400
			-- {item = 15453, nivel = 8, nivelJogador = 70, ferramenta = 2321, materiais = {{9814, 1}, {11226, 30}, {16105, 3}}, fabricarQuantidade = 1, tempo = 10, experiencia = 350, pontos = 25, chanceSucesso = 3500, maxChanceSucesso = 5000, aprender = 0, atributos = {defesa = {1, 3}}}, -- 2580
			-- {item = 21707, nivel = 9, nivelJogador = 1, ferramenta = 7450, materiais = {{9814, 1}, {21695, 10}, {5880, 10}}, fabricarQuantidade = 1, tempo = 0, experiencia = 410, pontos = 31, chanceSucesso = 1000, maxChanceSucesso = 2000, aprender = 0, atributos = {defesa = {0, 3}}},
			{item = 2534, nivel = 10, nivelJogador = 75, ferramenta = 2321, materiais = {{9814, 1}, {12405, 20}, {21241, 10}, {21244, 1}}, fabricarQuantidade = 1, tempo = 25, experiencia = 470, pontos = 38, chanceSucesso = 4000, maxChanceSucesso = 5500, aprender = 0, atributos = {defesa = {1, 3}}}, -- 1950
			...
			-- {item = 2522, nivel = 22, nivelJogador = 1, ferramenta = 2434, materiais = {{9814, 1}, {5920, 10}, {5882, 5}, {5889, 3}}, fabricarQuantidade = 1, tempo = 0, experiencia = 10, pontos = 10, chanceSucesso = 1000, maxChanceSucesso = 2000, aprender = 0, atributos = {defesa = {0, 3}}},
			-- {item = 8905, nivel = 25, nivelJogador = 1, ferramenta = 2422, materiais = {{9814, 1}, {13213, 10}, {13214, 10}, {13215, 10}, {13196, 10}, {13197, 10}, {13198, 10}}, fabricarQuantidade = 1, tempo = 0, experiencia = 10, pontos = 10, chanceSucesso = 1000, maxChanceSucesso = 2000, aprender = 0, atributos = {defesa = {0, 3}}},
			-- {item = 2523, nivel = 30, nivelJogador = 1, ferramenta = 2422, materiais = {{9814, 1}, {5892, 10}, {8301, 10}, {5887, 10}}, fabricarQuantidade = 1, tempo = 0, experiencia = 10, pontos = 10, chanceSucesso = 1000, maxChanceSucesso = 2000, aprender = 0, atributos = {defesa = {0, 3}}},
			...
			{item = 2409, nivel = 2, nivelJogador = 15, ferramenta = 2321, materiais = {{2350, 1}, {10611, 5}}, fabricarQuantidade = 1, tempo = 5, experiencia = 70, pontos = 3, chanceSucesso = 9000, aprender = 0, atributos = {ataque = {0, 3}}},--105
			{item = 2419, nivel = 2, nivelJogador = 15, ferramenta = 2321, materiais = {{2350, 1}, {8267, 2}, {13757, 2}}, fabricarQuantidade = 1, tempo = 5, experiencia = 75, pontos = 3, chanceSucesso = 9000, aprender = 0, atributos = {ataque = {0, 3}}},--110
			...
			{item = 3963, nivel = 4, nivelJogador = 25, ferramenta = 2321, materiais = {{2350, 1}, {5876, 4}, {5880, 2}}, fabricarQuantidade = 1, tempo = 7, experiencia = 130, pontos = 7, chanceSucesso = 8000, aprender = 0, atributos = {ataque = {1, 3}}},--330
			{item = 2392, nivel = 5, nivelJogador = 30, ferramenta = 7758, materiais = {{2350, 1}, {8299, 5}, {12505, 1}}, fabricarQuantidade = 1, tempo = 0, experiencia = 175, pontos = 10, chanceSucesso = 7000, maxChanceSucesso = 9000, aprender = 0, atributos = {ataque = {1, 3}}},--450
			{item = 2383, nivel = 6, nivelJogador = 35, ferramenta = 2321, materiais = {{2350, 1}, {11325, 5}, {12505, 1}}, fabricarQuantidade = 1, tempo = 0, experiencia = 230, pontos = 14, chanceSucesso = 7000, maxChanceSucesso = 9000, aprender = 0, atributos = {ataque = {1, 3}}},--650
			{item = 20092, nivel = 7, nivelJogador = 40, ferramenta = 2422, materiais = {{2350, 1}, {20089, 5}, {12505, 2}}, fabricarQuantidade = 1, tempo = 7, experiencia = 290, pontos = 19, chanceSucesso = 7000, maxChanceSucesso = 9000, aprender = 0, atributos = {ataque = {1, 3}}},--820
			{item = 7385, nivel = 8, nivelJogador = 45, ferramenta = 2321, materiais = {{2350, 1}, {21401, 20}, {12505, 2}}, fabricarQuantidade = 1, tempo = 0, experiencia = 350, pontos = 25, chanceSucesso = 6000, maxChanceSucesso = 8000, aprender = 0, atributos = {ataque = {1, 3}}},--970
			{item = 7408, nivel = 9, nivelJogador = 50, ferramenta = 2434, materiais = {{2350, 1}, {10561, 10}, {12505, 2}}, fabricarQuantidade = 1, tempo = 10, experiencia = 410, pontos = 31, chanceSucesso = 6000, maxChanceSucesso = 8000, aprender = 0, atributos = {ataque = {1, 3}}},--1170
			{item = 2407, nivel = 10, nivelJogador = 55, ferramenta = 2321, materiais = {{2395, 1}, {11227, 7}, {13757, 3}}, fabricarQuantidade = 1, tempo = 10, experiencia = 470, pontos = 38, chanceSucesso = 6000, maxChanceSucesso = 8000, aprender = 0, atributos = {ataque = {1, 3}}},--1440
