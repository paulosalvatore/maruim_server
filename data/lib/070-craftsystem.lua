...
profissoes = {
	[20000] = {
		...
		mesaTrabalhando = {},
		receitas = {
			{item = 2540, nivel = 1, nivelJogador = 10, ferramenta = 2321, materiais = {{9814, 1}, {10558, 20}}, fabricarQuantidade = 1, tempo = 3, experiencia = 20, pontos = 2, chanceSucesso = 7000, aprender = 0, atributos = {defesa = {1, 3}}},
			{item = 2525, nivel = 2, nivelJogador = 15, ferramenta = 2422, materiais = {{9814, 1}, {5880, 3}, {5900, 1}}, fabricarQuantidade = 1, tempo = 4, experiencia = 30, pontos = 2, chanceSucesso = 6500, aprender = 0, atributos = {defesa = {1, 3}}},
			...
			{item = 6131, nivel = 2, nivelJogador = 15, ferramenta = 2422, materiais = {{9814, 1}, {5899, 20}}, fabricarQuantidade = 1, tempo = 4, experiencia = 30, pontos = 3, chanceSucesso = 4000, aprender = 0, atributos = {defesa = {1, 3}}},
			...
			{item = 2515, nivel = 5, nivelJogador = 25, ferramenta = 2422, materiais = {{9814, 1}, {2154, 2}, {2158, 2}, {5880, 5}}, fabricarQuantidade = 1, tempo = 7, experiencia = 75, pontos = 5, chanceSucesso = 5000, aprender = 0, atributos = {defesa = {1, 3}}},
			...
			{item = 2516, nivel = 6, nivelJogador = 30, ferramenta = 2434, materiais = {{9814, 1}, {5920, 2}, {12413, 10}, {21401, 10}}, fabricarQuantidade = 1, tempo = 3, experiencia = 100, pontos = 10, chanceSucesso = 5000, aprender = 0, atributos = {defesa = {1, 3}}},
			{item = 21697, nivel = 20, nivelJogador = 1, ferramenta = 7777, materiais = {{9814, 1}, {10578, 10}, {10549, 10}, {8302, 10}}, fabricarQuantidade = 1, tempo = 15, experiencia = 800, pontos = 40, chanceSucesso = 1000, maxChanceSucesso = 3000, aprender = 0, atributos = {defesa = {0, 4}}},
			{item = 2537, nivel = 9, nivelJogador = 1, ferramenta = 2422, materiais = {{9814, 1}, {7249, 10}, {12399, 10}}, fabricarQuantidade = 1, tempo = 10, experiencia = 250, pontos = 20, chanceSucesso = 2000, aprender = 0, atributos = {defesa = {1, 3}}},
			...
			{item = 2528, nivel = 12, nivelJogador = 50, ferramenta = 2321, materiais = {{2510, 1}, {5880, 10}, {2159, 20}}, fabricarQuantidade = 1, tempo = 15, experiencia = 300, pontos = 20, chanceSucesso = 4000, aprender = 0, atributos = {defesa = {1, 3}}}, -- 2530
			{item = 2536, nivel = 13, nivelJogador = 70, ferramenta = 2321, materiais = {{9814, 1}, {11226, 30}, {16105, 3}}, fabricarQuantidade = 1, tempo = 10, experiencia = 450, pontos = 30, chanceSucesso = 3500, maxChanceSucesso = 5000, aprender = 0, atributos = {defesa = {1, 3}}}, -- 2580
			...
			{item = 2534, nivel = 15, nivelJogador = 1, ferramenta = 2321, materiais = {{9814, 1}, {12405, 30}, {10602, 20}}, fabricarQuantidade = 1, tempo = 7, experiencia = 650, pontos = 40, chanceSucesso = 1500, maxChanceSucesso = 3000, aprender = 0, atributos = {defesa = {1, 3}}}, -- 1230
			...
			-- {item = 12644, nivel = 65, nivelJogador = 1, ferramenta = 7450, materiais = {{9814, 1}, {12628, 10}, {12629, 5}}, fabricarQuantidade = 1, tempo = 0, experiencia = 10, pontos = 10, chanceSucesso = 1000, maxChanceSucesso = 2000, aprender = 0, atributos = {defesa = {0, 3}}},
			-- {item = 15408, nivel = 85, nivelJogador = 1, ferramenta = 2321, materiais = {{9820, 1}, {15423, 5}, {15430, 5}, {5880, 5}}, fabricarQuantidade = 1, tempo = 0, experiencia = 10, pontos = 10, chanceSucesso = 1000, maxChanceSucesso = 2000, aprender = 0, atributos = {armadura = {0, 3}}},
