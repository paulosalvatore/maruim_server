...
profissoes = {
	[20000] = {
		...
		receitas = {
			...
			{item = 2392, nivel = 5, nivelJogador = 30, ferramenta = 7758, materiais = {{2350, 1}, {8299, 5}, {12505, 1}}, fabricarQuantidade = 1, tempo = 0, experiencia = 175, pontos = 10, chanceSucesso = 7000, maxChanceSucesso = 2000, aprender = 0, atributos = {ataque = {1, 3}}},--450
			{item = 2383, nivel = 6, nivelJogador = 35, ferramenta = 2321, materiais = {{2350, 1}, {11325, 5}, {12505, 1}}, fabricarQuantidade = 1, tempo = 0, experiencia = 230, pontos = 14, chanceSucesso = 7000, maxChanceSucesso = 2000, aprender = 0, atributos = {ataque = {1, 3}}},--650
			{item = 20092, nivel = 7, nivelJogador = 40, ferramenta = 2422, materiais = {{2350, 1}, {20089, 5}, {12505, 2}}, fabricarQuantidade = 1, tempo = 7, experiencia = 290, pontos = 19, chanceSucesso = 7000, aprender = 0, atributos = {ataque = {1, 3}}},--820
			{item = 7385, nivel = 8, nivelJogador = 45, ferramenta = 2321, materiais = {{2350, 1}, {21401, 20}, {12505, 2}}, fabricarQuantidade = 1, tempo = 0, experiencia = 350, pontos = 25, chanceSucesso = 6000, maxChanceSucesso = 2000, aprender = 0, atributos = {ataque = {1, 3}}},--970
			{item = 7408, nivel = 9, nivelJogador = 50, ferramenta = 2434, materiais = {{2350, 1}, {10561, 10}, {12505, 2}}, fabricarQuantidade = 1, tempo = 10, experiencia = 410, pontos = 31, chanceSucesso = 6000, maxChanceSucesso = 9000, aprender = 0, atributos = {ataque = {1, 3}}},--1170
			{item = 2407, nivel = 10, nivelJogador = 55, ferramenta = 2321, materiais = {{2395, 1}, {11227, 7}, {13757, 3}}, fabricarQuantidade = 1, tempo = 10, experiencia = 470, pontos = 38, chanceSucesso = 6000, aprender = 0, atributos = {ataque = {1, 3}}},--1440
			...
			{item = 2451, nivel = 12, nivelJogador = 65, ferramenta = 2422, materiais = {{2350, 1}, {12426, 10}, {13757, 10}}, fabricarQuantidade = 1, tempo = 10, experiencia = 300, pontos = 50, chanceSucesso = 10000, aprender = 0, atributos = {ataque = {1, 3}}},--450
			...
			{item = 2446, nivel = 14, nivelJogador = 75, ferramenta = 7450, materiais = {{2350, 1}, {12422, 10}, {2354, 2}}, fabricarQuantidade = 1, tempo = 10, experiencia = 330, pontos = 50, chanceSucesso = 4000, maxChanceSucesso = 7000, aprender = 0, atributos = {ataque = {1, 3}}},--
			{item = 7383, nivel = 15, nivelJogador = 80, ferramenta = 2321, materiais = {{7385, 1}, {5880, 1}, {13757, 10}}, fabricarQuantidade = 1, tempo = 10, experiencia = 330, pontos = 50, chanceSucesso = 4000, maxChanceSucesso = 7000, aprender = 0, atributos = {ataque = {1, 3}}},--
			...
			{item = 7384, nivel = 19, nivelJogador = 100, ferramenta = 2321, materiais = {{2350, 1}, {5944, 5}, {5880, 10}}, fabricarQuantidade = 1, tempo = 12, experiencia = 350, pontos = 65, chanceSucesso = 3000, maxChanceSucesso = 5000, aprender = 0, atributos = {ataque = {0, 4}}},--1130
