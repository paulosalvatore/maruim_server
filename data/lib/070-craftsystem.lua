...
profissoes = {
	[20000] = {
		...
		receitas = {
			...
			{item = 7385, nivel = 8, nivelJogador = 45, ferramenta = 2321, materiais = {{2350, 1}, {21401, 20}, {12505, 2}}, fabricarQuantidade = 1, tempo = 10, experiencia = 350, pontos = 25, chanceSucesso = 6000, maxChanceSucesso = 8000, aprender = 0, atributos = {ataque = {1, 3}}},--970
